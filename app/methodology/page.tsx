    ...
    <main className="site-shell methodology-page">
      ...
      <section className="method-block" id="model">
        ...
        <div className="method-copy">
          ...
          <p className="model-distinction"><strong>Choose your own intervals.</strong> Each dated injection contributes exactly once, at 24 × the number of calendar days since the earliest entered date, plus its Morning, Afternoon, or Night offset. Calendar days use a fixed 24-hour grid, independent of daylight-saving changes. The graph starts at midnight on the earliest date and ends 168 modeled hours after the latest injection, without rounding to whole weeks. Both compartment options use this schedule. Compare shows each injection separately; Accumulate sums them. Up to 100 injections are supported within a total graph span of 520 weeks.</p>
