    ...
    <main className="site-shell methodology-page">
      ...
      <section className="method-block" id="variable-dates">
        ...
        <div className="method-copy">
          ...
          <p>The calculator remembers an explicitly selected dose for its medication. Choosing “use latest entered dose” keeps the default linked to the most recent plotted injection. Reset clears the current tab’s saved inputs, including its calculator entries. Saved values are not sent to a server or synced between devices or browsers. Anyone using the same browser profile can see them; clearing site data also removes them. Browser settings or private browsing may prevent saving or retaining inputs, in which case the plotter remains usable and displays a storage notice.</p>
