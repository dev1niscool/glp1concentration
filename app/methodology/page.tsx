    ...
    <main className="site-shell methodology-page">
      ...
      <section className="method-block" id="model">
        ...
        <div className="method-copy">
          ...
          <div className="equation-card">
            ...
            <small>wα = (α−k₂₁)/(α−β) and wβ = (k₂₁−β)/(α−β). The fixed 70 kg reference calculation uses this closed-form solution.</small>
          </div>
          <div className="equation-card">
          ...
          <div className="equation-card">
            <span>Tirzepatide — privacy opt-out reduction</span>
            <code>t½ = 5.4 d · V/F = 10.3 L · kₐ = 0.0373 h⁻¹</code>
            <small>No published overall accuracy percentage exists for this one-compartment reduction. At the 70 kg reference its 5 mg peak is about 32% lower and about 31 hours later than the two-compartment curve.</small>
          </div>
          ...
          <ol className="process-list">
            ...
            <li><span>2</span><div><strong>Apply body size over time</strong><p>If a current weight is supplied, weight changes linearly from first-dose weight to current weight at today’s date and stays constant afterward. This interpolation is an explicit approximation.</p></div></li>
            <li><span>3</span><div><strong>Sample the timeline</strong><p>The body-size-adjusted tirzepatide differential equations are integrated in one-hour Runge–Kutta steps. All graph curves and AUC values are retained at six-hour intervals through 1–520 weeks.</p></div></li>
        ...
        <div className="method-copy">
          <div className="parameter-table-wrap">
            <table className="parameter-table">
              ...
              <tbody>
                <tr><th>Model structure</th><td>One compartment</td><td>Two compartments by default; one-compartment privacy opt-out</td><td>One-compartment surrogate</td></tr>
                ...
                <tr><th>One-compartment V/F</th><td>12.2 L</td><td>10.3 L opt-out only</td><td>7.36 L cohort mean</td></tr>
          ...
          <div className="parameter-notes">
            ...
            <article><span>TIRZ</span><h3>Tirzepatide</h3><p>Schneck & Urva reported a two-compartment model with fixed-effect values at the 70 kg reference: F 0.80, kₐ 0.0373 h⁻¹, CL 0.0329 L/h, Q 0.126 L/h, Vc 2.47 L, and Vp 3.98 L. The default plot scales CL and Q by current total weight and scales Vc and Vp using the paper’s sex- and BMI-derived fat-free mass equation. It reports concentration in the central plasma compartment but cannot reproduce the paper’s unexplained individual variability.</p></article>
      ...
      <section className="method-block" id="checks">
        ...
        <div className="method-copy">
          <div className="check-grid">
            ...
            <article><span className="check-mark">✓</span><h3>Body-size equations</h3><p>Automated checks reproduce the paper’s 0.8 allometric scaling for CL and Q, the sex-specific fat-free mass equations, the 0.482 fat-mass fraction, and linear starting-to-current weight interpolation.</p></article>
            <article><span className="check-mark">✓</span><h3>Opt-out difference disclosed</h3><p>At 5 mg and the fixed 70 kg reference, the one-compartment option peaks at 350.7 ng/mL after 60.8 hours versus 515.0 ng/mL after 29.6 hours for the two-compartment model. This is a model comparison, not an accuracy score against an individual.</p></article>
          ...
          <div className="audit-strip"><span>Automated calculation checks</span><strong>body-size covariates</strong><strong>weight interpolation</strong><strong>two-compartment AUC balance</strong><strong>privacy opt-out curve</strong></div>
        </div>
      </section>
      ...
      <section className="method-block" id="limits">
        ...
        <div className="method-copy limit-copy">
          <p>Actual exposure varies with body size, injection timing and site, formulation, adherence, individual clearance, assay method, and other clinical factors. Tirzepatide body-size inputs refine the population estimate but do not identify an individual’s true PK parameters.</p>
          <ul>
            ...
            <li><strong>Weight history is approximated.</strong> When both weights are entered, the graph assumes linear change from the first dose through today. Actual weight trajectories are rarely perfectly linear.</li>
            <li><strong>No one-compartment accuracy percentage.</strong> The source model does not report one, so the opt-out path discloses its peak difference without presenting a fabricated overall score.</li>
